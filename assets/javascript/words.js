let wordArray = [
    {
        ...
        examples: ["Dá mhéid ar ghaibh sé tríd agus do deineadh mícheart air ní dheárna sé ainbheart riamh: beart nó gníomh olc.", "Cad eile é ach ainbheart luighe trom ar bhochtaibh? gníomh olc.", "Go maithidh Dia dho is iomdha ainbheart do rinne sé ag scriosadh na ndaoine as a mbailtibh: olca gránda."]
    },
    {
        word: "aithdheinim",
        grammar: "b.a.",
...
for (var i = 0; i < wordArray.length; i++) {
    ...
    for (var e = 0; e < wordArray.definition; e++);
        htmlString += "<p>" + wordArray[i].definition + "</p>"; {
    }
